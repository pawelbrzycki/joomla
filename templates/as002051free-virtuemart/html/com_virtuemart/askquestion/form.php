...
<div class="ask-a-question-view">
	...
	<div class="product-summary">
		<div  class="width100 floatleft">
			<h2 id="vm_askquestion_heading"><?php echo $this->product->product_name ?></h2>
	...
	<div class="form-field">
        ...
        <div style="padding-bottom: 10px;" >
			<label class="user_name"><?php echo JText::_('COM_VIRTUEMART_USER_FORM_NAME')  ?> : </label> 
        ...
        <div style="padding-bottom: 10px;">
			<label class="email"><?php echo JText::_('COM_VIRTUEMART_USER_FORM_EMAIL')  ?> : </label> 
        ...
        <div id="vm_askform_textarea" style="padding-bottom: 10px;">
			<label>
				<?php
			...
			<div class="submit">
				...
				<div class="width100">
					...
					<input style="width: 40px !important;" type="text" value="0" size="4" class="counter" id="counter" name="counter" maxlength="4" readonly="readonly" />
				</div>
