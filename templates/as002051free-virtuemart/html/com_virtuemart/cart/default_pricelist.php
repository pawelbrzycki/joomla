...
?>
<div class="vmcart_heading"><?php echo JText::_ ('COM_VIRTUEMART_CART_SHIPPING'); ?> </div>
...
<div class="vmcart_heading"><?php echo JText::_ ('COM_VIRTUEMART_ORDERS_VIEW_DEFAULT_TITLE') ?></div>
