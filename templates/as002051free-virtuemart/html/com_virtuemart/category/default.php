...
<form action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=category&limitstart=0&virtuemart_category_id=' . $this->category->virtuemart_category_id); ?>" method="get">
	...
	<div class="virtuemart_search">
		<div id="vm_searchcustom_box"><?php // echo $this->searchcustom ?></div>
		<div><?php echo $this->searchcustomvalues ?></div>
...
<div class="orderby-displaynumber">
	...
	<div class="width15 floatleft display-number"><?php echo $this->vmPagination->getResultsCounter ();?><br/><?php echo $this->vmPagination->getLimitBox (); ?></div>
...
<div id="tabs" class="tabs-position prod">
            <ul class="tabs floatright">
                <li class="first"><a href="#tabs-1">&nbsp;</a></li>
                <li class="second"><a href="#tabs-2">&nbsp;</a></li>
                <li class="third"><a href="#tabs-3">&nbsp;</a></li>
            </ul> 
	...
	<?php
		...
		<div class="product floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?>">
            ...
            <div class="width25 floatleft">
                    ...
                    <div class="vm_product_image_box">
            ...
            <div class="width40 floatleft padding20">
                ...
                <div class="width20 floatright padding20 custom-product-price" >
    ...
    <?php
        ...
        <div class="product floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?>">
            ...
            <h2><?php echo JHTML::link ($product->link, $product->product_name); ?></h2>
                ...
                <?php
                     if($BrowseProducts_per_row==1)
                     {
                         echo '<div class="width30 floatleft">';
                 ?>
                        
                 <?php
                     }
                     else
                         echo '<div class="width100 floatleft">'
                  ?>
                ...
                <?php
                     if($BrowseProducts_per_row==1)
                     {
                         echo '<div class="width50 floatright top50">';
                 ?>
                        
                 <?php
                     }
                     else
                         echo '<div class="width100 floatright top20">'
                  ?>
...
<script type="text/javascript" src="<?php echo $gpath ?>/html/com_virtuemart/category/jquery-ui.min.js"></script>
...
jQuery(document).ready(function($) {
    asjQuery(function(){
        ...
        asjQuery('.tab_container').css('visibility', 'visible');
    });
});
</script>
