...
<div class="productdetails-view productdetails">
    ...
    ?>
        ...
        {
        echo '<div id="vm_icon_pdf">' .$this->linkIcon($link . '&format=pdf', 'COM_VIRTUEMART_PDF', 'pdf_button', 'pdf_button_enable', false).'</div>';
        }
        echo '<div id="vm_icon_print">' .$this->linkIcon($link . '&print=1', 'COM_VIRTUEMART_PRINT', 'printButton', 'show_printicon').'</div>';
        echo '<div id="vm_icon_email">' .$this->linkIcon($MailLink, 'COM_VIRTUEMART_EMAIL', 'emailButton', 'show_emailfriend').'</div>';
        ?>
        <div class="clear"></div>
...
?>
	...
	<div class="width40 floatright">
		...
		if ($this->showRating) {
			...
			?>
			<span class="vote">
                <span class="floatleft top10">
                    <?php echo JText::_('COM_VIRTUEMART_RATING') . ' ' . JText::_('COM_VIRTUEMART_UNRATED') ?>
                </span>
            </span>
			    <?php
			} else {
			    $ratingwidth = $this->rating->rating * 20; //I don't use round as percetntage with works perfect, as for me
			    ?>
			<span class="vote">
            <span class="floatleft top10">
