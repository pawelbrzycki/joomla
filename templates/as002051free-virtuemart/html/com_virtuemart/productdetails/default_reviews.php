...
if ($this->allowRating || $this->showReview) {
	...
	$ratingWidth = $maxrating * 20;
	for ($num = 0; $num <= $maxrating; $num++) {
		$stars[] = '
				<span title="' . (JText::_ ("COM_VIRTUEMART_RATING_TITLE") . $num . '/' . $maxrating) . '" class="vmicon ratingbox" style="display:inline-block;width:' . 20 * $maxrating . 'px;">
					<span class="stars-orange" style="width:' . (20 * $num) . 'px">
					</span>
				</span>';
	} ?>
     ...
     <div class="toggle_content 2">
	    ...
	    if ($this->allowReview) 
        {
		    ...
		    <div class="write-reviews">
			    ...
			    if ($review_editable) {
				    ?>
				    <span class="step"><?php echo JText::sprintf ('COM_VIRTUEMART_REVIEW_COMMENT', VmConfig::get ('reviews_minimum_comment_length', 0), VmConfig::get ('reviews_maximum_comment_length', 2000)); ?></span>
				    <br/>
