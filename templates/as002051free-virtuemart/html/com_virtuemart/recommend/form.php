...
<div class="ask-a-question-view">
	...
	<div class="form-field">
		...
		<form method="post" class="form-validate" action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id='.$this->product->virtuemart_product_id.'&virtuemart_category_id='.$this->product->virtuemart_category_id.'&tmpl=component') ; ?>" name="askform" id="askform" >
			<label><?php echo JText::_('COM_VIRTUEMART_USER_FORM_EMAIL')  ?>  : </label> <input type="text" value="" name="email" id="email" size="30" class="validate[required,custom[email]]"/>
				<br /><br /><br />
			<label>
				<?php
				...
				<br /><br />
				<textarea title="<?php echo $ask_comment ?>" class="validate[required,minSize[<?php echo $min ?>],maxSize[<?php echo $max ?>]] field bottom20" id="comment" name="comment" rows="10"></textarea>
			
                <div class="width100 floatleft bottom20">
                    <label> <?php echo JText::_('COM_VIRTUEMART_ASK_COUNT')  ?> </label>
                    <input type="text" value="0" size="4" class="counter top10 " style="width: 60px !important;" id="counter" name="counter" maxlength="4" readonly="readonly" />
                </div>

				<div class="submit bottom20">
					<input class="button" type="submit" name="submit_ask" title="<?php echo JText::_('COM_VIRTUEMART_RECOMMEND_SUBMIT')  ?>" value="<?php echo JText::_('COM_VIRTUEMART_RECOMMEND_SUBMIT')  ?>" />
