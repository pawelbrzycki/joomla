...
//$url = $uri->toString(array('path', 'query', 'fragment'));
    ...
    if ($this->order  ) {
	    ...
	    <form action="<?php echo JRoute::_( 'index.php', true, 0); ?>" method="post" name="com-login" class="vm_loginform" >
...
<?php   }
    ...
    ?>
    <div class="vmcart_heading"><?php echo JText::_('COM_VIRTUEMART_LOGIN'); ?></div>
    <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="com-login" class="vm_loginform" >
	<?php if (!$this->from_cart ) { ?>
	<div>
		<p class="bottom20"><?php echo JText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></p>
	</div>
<div class="clear"></div>
<?php } else { ?>
        <p style="margin: 0 0 20px;"><?php echo JText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></p>
<?php }   ?>
        <div class="width97 margin_auto">
        <div class="width75 floatleft" >
        <div class="width100 floatleft" id="com-form-login-username">
            <label class="top3">User Name</label>
        ...
        <div class="width100 floatleft" id="com-form-login-password">
            <?php if ( JVM_VERSION===1 ) { ?>
            <label class="top3">Password</label>
        ...
        <div class="width100 floatleft" id="com-form-login-remember">
        ...
        <div class="width100 floatleft top3 " >
        ...
        <p class="width100 floatleft top3 " >
...
<?php  }else if ($user->id  ){ ?>
    <div class="vmcart_heading"><?php echo JText::_('COM_VIRTUEMART_LOGIN'); ?></div>
   <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="login" id="form-login" class="vm_loginform">
   <div class="width100 floatleft">
    <label style="padding-right: 20px;"> <?php echo JText::sprintf( 'COM_VIRTUEMART_HINAME', $user->name ); ?>  </label>    
