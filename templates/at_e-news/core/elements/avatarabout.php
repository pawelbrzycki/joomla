...
class JFormFieldAvatarAbout extends JFormField
{
	...
	protected function getLabel()
	{
		...
		$label .= '<h1><a title="Avatar - Template Framework - easy to build a website" target="_blank" href="http://joomavatar.com">'. $this->element['fullname'] .' '. $this->element['version'] . ' ' . $this->element['edition'] . '</a></h1>';
