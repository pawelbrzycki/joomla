...
<html lang="<?php echo $template->language; ?>" dir="<?php echo $template->direction; ?>" >
	<head>
		...
		<style type="text/css">
			.avatar-wrapper{
				width: <?php echo $template->params->get('template_width'); ?>px;
				margin: auto;
			}
			#at-body-wrapper{
				width: <?php echo $template->params->get('template_width')-20; ?>px;
			}
			#at-body-wrapper .avatar-wrapper{
				width: <?php echo (int)$template->params->get('template_width')-20; ?>px;
			}
	...
	<body id="avatar-template" class="<?php echo ($this->_responsive) ? 'avatar-responsive' : '';?>">
		<?php 
		...
		<div class="clearfix">
			...
			<div id="at-body-wrapper">
			
			<?php if ($posPromoTopLeft || $posPromoTopMiddle || $posPromoTopRight || $posUser10 || $posUser8 || $posUser9 || $posContentTop || $posUser11 || $posUser12 || $posUser13 || $posUser14) :?>
			...
			$posUser5 || $posUser6 || $posUser7 || $posUser15 || $posUser16 || $posUser17 || $posUser18
			|| $posContentBottom) :?>
