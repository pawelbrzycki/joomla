...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php if($this->item->params->get('catItemImage') && !empty($this->item->image)): ?>
	  <!-- Item Image -->
		    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
		    	<div class="at-item-image" style="background-image: url('<?php echo $this->item->image; ?>');"><div class="at-backdrop"></div></div>   	
		    </a>
		  <div class="clr"></div>
	 <?php endif; ?> 
	...
	<div class="catItemHeader">
	  ...
	  <h2 class="at-item-title">
			...
			<span class="catItemEditLink">
				<a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>"><?php echo JText::_('K2_EDIT_ITEM'); ?></a>
			</span>
			<?php endif; ?>
	 ...
	 <?php if (($this->item->params->get('catItemAuthor')) or ($this->item->params->get('catItemCategory')) or ($this->item->params->get('catItemDateCreated')) or ($this->item->params->get('catItemTags')) or ($this->item->params->get('catItemAttachments')) or ($this->item->params->get('catItemHits'))) : ?>
	 <div class="at-item-info">
		...
		<div class="catItemDateCreated">
			<?php echo JHTML::_('date', $this->item->created , JText::_('d/m/Y H:i')); ?>
		</div>
		<?php endif; ?>
  ...
  <div class="at-item-k2-body">
	...
	<?php if($this->item->params->get('catItemTags') || $this->item->params->get('catItemAttachments')): ?>
	  <div class="at-item-links catItemLinks">
		  <?php if($this->item->params->get('catItemTags') && count($this->item->tags)): ?>
		  <!-- Item tags -->
		  <div class="catItemTagsBlock at-item-tags">
			<ul class="catItemTags">
			    <?php foreach ($this->item->tags as $tag): ?>
			    <li><a class="tag" href="<?php echo $tag->link; ?>"><?php echo $tag->name; ?></a></li>
			    <?php endforeach; ?>
			</ul>
			<div class="clr"></div>
		  </div>
  ...
  <?php endif; ?>
	...
	<div class="at-readmore-block">
		...
		<!-- Item "read more..." link -->
		<div class="at-item-readmore catItemReadMore">
