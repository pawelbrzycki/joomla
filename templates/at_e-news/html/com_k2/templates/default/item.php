...
<div id="k2Container" class="at-main-border at-item itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <?php if (($this->item->params->get('itemAuthor')) or ($this->item->params->get('catItemCategory')) or ($this->item->params->get('itemDateCreated')) or ($this->item->params->get('catItemTags')) or ($this->item->params->get('catItemAttachments')) or ($this->item->params->get('catItemHits'))) : ?>
	  ...
	  <!-- Item fulltext -->
	  <div class="at-item-fulltext itemFullText">
	...
	<?php if($this->item->params->get('itemVideo') && !empty($this->item->video)): ?>
	  ...
	  <div class="itemExtraFields">
	  	...
	  	<ul>
			...
			<li type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
	...
	<div class="itemSocialSharing">
		...
		<div class="itemGooglePlusOneButton">
			<g:plusone annotation="inline" width="120" callback="atgooglePlusClick"></g:plusone>
			<script type="text/javascript">
			  (function() {
  ...
  <div class="itemLinks">
	  ...
	  <div class="catItemTagsBlock at-item-tags">
	  	<div><?php echo JText::_('K2_TAGGED_UNDER'); ?></div>
