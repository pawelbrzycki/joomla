...
<div class="at-readmore-category">
	<a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($idbase));?>"><?php echo JText::_('MOD_ARTICLES_CATEGORY_READ_MORE_TITLE');?></a>
</div>