...
// load css component 
$this['asset']->addFile('css', 'css:uikit.gradient.css');
$this['asset']->addFile('css', 'css:kunena.css');
$this['asset']->addFile('css', 'css:font-awesome.min.css');
...
$fonts = array(
	...
	'kiteone' => $http.'://fonts.googleapis.com/css?family=Kite+One');
...
//sections
$css[] .= sprintf('.content-texture, .sheet { background-color: #%s; }', $this['config']->get('content_bg_color'));
$css[] .= sprintf('#bottom-block { background-color: #%s; }', $this['config']->get('bottom_bg_color'));
$css[] .= sprintf('#newsletter { background-color: #%s; }', $this['config']->get('newsletter_bg_color'));
$css[] .= sprintf('#footer-block, #bottom-c { background-color: #%s; }', $this['config']->get('footer_bg_color'));
