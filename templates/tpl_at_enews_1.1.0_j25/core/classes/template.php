...
class AvatarTemplate extends JObject {
	...
	public function getJSFiles() 
	{
		return $this->_js['template'] = array(
			$this->_jtemplate->baseurl .'/templates/'. $this->_jtemplate->template .'/core/libraries/bootstrap/js/bootstrap.min.js',
	...
	{
		$this->_css['system'][] = $this->_jtemplate->baseurl .'/templates/'. $this->_jtemplate->template .'/core/libraries/bootstrap/css/bootstrap.min.css';
		
		if ($this->_responsive) {
			$this->_css['system'][] = $this->_jtemplate->baseurl .'/templates/'. $this->_jtemplate->template .'/core/assets/css/responsive.css';
			$this->_css['system'][] = $this->_jtemplate->baseurl .'/templates/'. $this->_jtemplate->template .'/core/libraries/bootstrap/css/bootstrap-responsive.min.css';
		}
	 ...
	 */
	 ...
	 public function loadJquery() {
	 	$script = '<script src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js" type="text/javascript"></script><script type="text/javascript">jQuery.noConflict();</script>';
		return $script;
	 }
	...
	public function panelSettings() 
	{
		...
		$path = JPATH_THEMES.DS.$this->_jtemplate->template.DS;
		$uri = JFactory::getURI();
		...
		$url = JURI::root(true).'/templates/'.$this->_jtemplate->template.'/core/libraries/js/color-picker/';
		$doc->addStyleSheet($url.'jquery.miniColors.css');
		$doc->addScript($url.'jquery.miniColors.js');
