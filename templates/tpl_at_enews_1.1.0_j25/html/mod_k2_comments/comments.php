...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="at-enews-k2-commenters k2LatestCommentsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">

	<?php if(count($comments)): ?>
	<ul class="the-comment">
		...
		<li>
			...
			<div class="lcUsername"><?php echo JText::_('K2_WRITTEN_BY'); ?>
